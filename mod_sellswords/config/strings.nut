...
::Const.Strings.PerkDescription.ArmorMasteryCloth <- @"
...
::Const.Strings.PerkDescription.ArmorMasteryLight <- @"
...
::Const.Strings.PerkDescription.ArmorMasteryMedium <- @"
...
::Const.Strings.PerkDescription.ArmorMasteryHeavy <- @"
...
::Const.Strings.PerkDescription.crClarity <- @"
...
::Const.Strings.PerkDescription.crHybridization <- @"
...
::Const.Strings.PerkDescription.crresilient <- @"
Keep it together!
...
::Const.Strings.PerkDescription.crIronsideweak <- @"
...
::Const.Strings.PerkDescription.crBruiser <- @"
...
::Const.Strings.PerkDescription.DryadSummonWolf <- @"
...
::Const.Strings.PerkDescription.DryadSummonSnake <- @"
[color=%negative%][u]Requires:[/u] Heart of the Forest[/color]
...
::Const.Strings.PerkDescription.DryadSummonUnhold <- @"
[color=%negative%][u]Requires:[/u] Heart of the Forest[/color]
...
::Const.Strings.PerkDescription.DryadSummonLindwurm <- @"
[color=%negative%][u]Requires:[/u] Heart of the Forest[/color]
...
::Const.Strings.PerkDescription.DryadForestBlessing <- @"
[color=%negative%][u]Requires:[/u] Heart of the Forest[/color]
...
::Const.Strings.PerkDescription.DryadNaturalRegrowth <- @"
[color=%negative%][u]Requires:[/u] Heart of the Forest[/color]

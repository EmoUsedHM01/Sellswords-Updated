...
::Const.Perks.CalmTree.Tree[4] = [::Const.Perks.PerkDefs.crClarity];
::Const.Perks.CalmTree.Tree[5] = [::Const.Perks.PerkDefs.LoneWolf];
::Const.Perks.CalmTree.Tree[6] = [::Const.Perks.PerkDefs.LegendMindOverBody];
...
::Const.Perks.FastTree.Tree[1] = [::Const.Perks.PerkDefs.QuickHands,::Const.Perks.PerkDefs.LegendQuickStep];
::Const.Perks.FastTree.Tree[2] = [::Const.Perks.PerkDefs.Relentless];
::Const.Perks.FastTree.Tree[3] = [];
::Const.Perks.FastTree.Tree[4] = [::Const.Perks.PerkDefs.PTRVigorousAssault];
...
::Const.Perks.FitTree.Tree[1] = [::Const.Perks.PerkDefs.crbeforethestorm];
::Const.Perks.FitTree.Tree[2] = [::Const.Perks.PerkDefs.PTRTheRushOfBattle];
::Const.Perks.FitTree.Tree[3] = [];
::Const.Perks.FitTree.Tree[4] = [::Const.Perks.PerkDefs.crBackswing];
...
::Const.Perks.IndestructibleTree.Tree[2] = [::Const.Perks.PerkDefs.crresilient];
...
::Const.Perks.IntelligentTree.Tree[4] = [::Const.Perks.PerkDefs.PTRKnowTheirWeakness];
::Const.Perks.IntelligentTree.Tree[5] = [::Const.Perks.PerkDefs.LegendAssuredConquest];
::Const.Perks.IntelligentTree.Tree[6] = [::Const.Perks.PerkDefs.LegendAdaptive];
...
::Const.Perks.LargeTree.Tree[5] = [::Const.Perks.PerkDefs.LegendMuscularity];
::Const.Perks.LargeTree.Tree[6] = [::Const.Perks.PerkDefs.crGrandslam];

// organised tree

::Const.Perks.OrganisedTree.Tree[0] = [::Const.Perks.PerkDefs.BagsAndBelts];
::Const.Perks.OrganisedTree.Tree[1] = [::Const.Perks.PerkDefs.LegendPacifist];
...
::Const.Perks.OrganisedTree.Tree[5] = [::Const.Perks.PerkDefs.PTRVigilant];
::Const.Perks.OrganisedTree.Tree[6] = [::Const.Perks.PerkDefs.LegendAssuredConquest];

// sturdy tree

::Const.Perks.SturdyTree.Tree[0] = [::Const.Perks.PerkDefs.Recover];
::Const.Perks.SturdyTree.Tree[1] = [::Const.Perks.PerkDefs.Steadfast];
...
::Const.Perks.SturdyTree.Tree[5] = [::Const.Perks.PerkDefs.SteelBrow];
...
::Const.Perks.TrainedTree.Tree[1] = [::Const.Perks.PerkDefs.crAnchor];
...
::Const.Perks.TrainedTree.Tree[5] = [::Const.Perks.PerkDefs.crBattlerhaposdy];

::Mod_Sellswords.HooksMod.hook("scripts/items/tools/smoke_bomb_item", function ( q ) {
	...
	{
		__original();
		this.m.Description = "A small pot that quickly creates a dense smoke cloud when broken on the ground. Useful for covering movement. Is refilled after each battle, consuming 30 ammunition per use.";
		this.m.Value = 1000;

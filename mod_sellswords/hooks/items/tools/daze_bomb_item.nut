::Mod_Sellswords.HooksMod.hook("scripts/items/tools/daze_bomb_item", function ( q ) {
	...
	{
		__original();
		this.m.Description = "A throwable pot filled with mysterious powders that react violently on impact to create a bright flash and loud bang. Will daze anyone close by. Is refilled after each battle, consuming 30 ammunition per charge.";
		this.m.Value = 1000;

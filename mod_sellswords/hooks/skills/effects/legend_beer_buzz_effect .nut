::Mod_Sellswords.HooksMod.hook("scripts/skills/effects/legend_beer_buzz_effect", function( q ) {
	...
	{
		return "After guzzling beer, this character has [color=%positive%]+9%[/color] damage, damage reduction and  [color=%positive%]+18%[/color] Resolve. At the expense of [color=%negative%]-6%[/color] initiative and hitchance for [color=%negative%]" + this.m.TurnsLeft + "[/color] turn(s).";
	}
	...
	q.getTooltip = @(__original) function()
	{
		return [
			...
			},
			{
				...
				text = "[color=%positive%]+9%[/color] Damage"
			},	
			{
				id = 11,
				type = "text",
				icon = "ui/icons/sturdiness.png",
				text = "[color=%positive%]+9%[/color] Damage Reduction"
			},			
			{
				id = 11,
				type = "text",
			...
			},
			{
				...
				text = "[color=%negative%]-6%[/color] Melee Skill"
			},
			{
				id = 11,
				type = "text",
				icon = "ui/icons/ranged_skill.png",
				text = "[color=%negative%]-6%[/color] Ranged Skill"
			},
			{
				id = 11,
				type = "text",

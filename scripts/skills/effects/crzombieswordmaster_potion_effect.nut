this.crzombieswordmaster_potion_effect <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "effects.crzombieswordmaster_potion";
		this.m.Name = "Unabated Beat";
	...
	{
		_properties.FatigueToInitiativeRate *= 0;
	}

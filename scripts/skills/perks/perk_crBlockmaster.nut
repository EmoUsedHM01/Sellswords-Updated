this.perk_crBlockmaster <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "perk.crBlockmaster";
		this.m.Name = this.Const.Strings.PerkName.crBlockmaster;
	...
	function onBeforeDamageReceived( _attacker, _skill, _hitInfo, _properties )
	{
		...
		{
			bonus = this.Math.floor(0.4 * Roll * ourMeleeskill / enemyCurrentMeleeskill);
		}		

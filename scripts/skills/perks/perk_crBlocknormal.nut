this.perk_crBlocknormal <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "perk.crBlocknormal";
		this.m.Name = this.Const.Strings.PerkName.crBlocknormal;
	...
	function onBeforeDamageReceived( _attacker, _skill, _hitInfo, _properties )
	{
		...
		{
			bonus = this.Math.floor(0.2 * Roll * ourMeleeskill / enemyCurrentMeleeskill);
		}		

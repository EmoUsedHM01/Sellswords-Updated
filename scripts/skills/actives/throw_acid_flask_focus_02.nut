this.throw_acid_flask_focus_02 <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.throw_acid_flask_focus_02";
		...
		this.m.Icon = "skills/active_cr_04.png";
	...
	function applyAcid( _target )
	{
		...
		if (poison == null)
		{
			local ae = this.new("scripts/skills/effects/acid_effect_strong");

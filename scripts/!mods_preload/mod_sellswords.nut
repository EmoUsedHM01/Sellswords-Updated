...
::Mod_Sellswords.HooksMod.queue(">mod_msu", ">mod_legends", ">mod_legends_PTR", ">mod_breditor", "<mod_AC", "<mod_nggh_magic_concept", "<mod_world_editor_legends", function()
{
	...
	local settingSellswordsPerk = page.addEnumSetting("SellswordsPerk", "Student", ["Backstabber", "Berserker", "Dodge", "Fortified Mind", "Greed", "Mind Over Body", "Nine Lives", "Pathfinder", "Quick Hands", "Rotation", "Steel Brow", "Student", "Underdog"], "Sellsword Scenario Perk", "Choose a company perk to be added when you recruit a bro for the Sellswords Scenario.\n\nStudent by default.");

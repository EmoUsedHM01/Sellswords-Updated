this.quiver_of_freezing_arrows <- this.inherit("scripts/items/ammo/ammo", {
	m = {},
	function create()
	{
		this.m.ID = "ammo.ice_arrows";
		this.m.Name = "Quiver of Freezing Arrows";
		this.m.Description = "A quiver of arrows, the heads of which are tipped by the Ebonice of the North.\nIt will chill targets for one turn, reducing their action points by 3 and initiative by 30.\nEach ammo refilled costs thrice as much compared to conventional ammunition.\nIs automatically refilled after each battle if you have enough ammunition.";
		this.m.Icon = "ammo/quiver_ice.png";
		this.m.IconEmpty = "ammo/quiver_ice_empty.png";

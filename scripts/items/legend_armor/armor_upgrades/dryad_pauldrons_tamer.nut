this.dryad_pauldrons_tamer <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	m = {},
	function create()
	{
		this.legend_armor_upgrade.create();
		this.m.Type = this.Const.Items.ArmorUpgrades.Attachment;
		this.m.ID = "legend_armor_upgrade.dryad_pauldrons_tamer";
		this.m.Name = "Greenwood Tamer's Pauldrons";

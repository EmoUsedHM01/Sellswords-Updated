this.dryad_pauldrons_shaman <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	m = {},
	function create()
	{
		this.legend_armor_upgrade.create();
		this.m.Type = this.Const.Items.ArmorUpgrades.Attachment;
		this.m.ID = "legend_armor_upgrade.dryad_pauldrons_shaman";
		this.m.Name = "Greenwood Shaman Pauldrons";

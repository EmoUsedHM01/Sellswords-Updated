this.cr_named_noble_mail_armor <- this.inherit("scripts/items/legend_armor/legend_named_armor_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Icon = "armor/icon_cr_named_noble_mail_armor.png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "armor/icon_cr_named_noble_mail_armor.png";
		this.m.OverlayIconLarge = "armor/inventory_cr_named_noble_mail_armor.png";		
	}

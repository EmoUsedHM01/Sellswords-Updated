this.dryad_cloak_warrior <- this.inherit("scripts/items/legend_armor/legend_armor_cloak", {
	m = {},
	function create()
	{
		this.legend_armor_cloak.create();
		this.m.ID = "legend_armor.body.dryad_cloak_warrior";
		this.m.Name = "Greenwood Warrior Cloak";

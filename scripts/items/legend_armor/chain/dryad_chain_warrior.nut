this.dryad_chain_warrior <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	m = {},
	function create()
	{
		this.legend_armor_upgrade.create();
		this.m.Type = this.Const.Items.ArmorUpgrades.Chain;
		this.m.ID = "legend_armor.body.dryad_chain_warrior";
		this.m.Name = "Greenwood Warrior's Gorget";

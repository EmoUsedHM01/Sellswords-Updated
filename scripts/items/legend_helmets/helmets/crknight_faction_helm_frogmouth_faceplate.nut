this.crknight_faction_helm_frogmouth_faceplate <- this.inherit("scripts/items/legend_helmets/hood/legend_helmet_enclave_bevor", {
	m = {},
	function create()
	{
		this.legend_helmet_enclave_bevor.create();
		this.m.ID = "armor.crknight_faction_helm_frogmouth_faceplate";
		this.m.Name = "Bevor";
	...
	function setupArmor( _variant )
	{
		...
		local top = this.new("scripts/items/legend_helmets/top/legend_helmet_faceplate_winged");		//ss60,-4,800,0	
		this.setUpgrade(top);

this.crknight_faction_helm_great_helm_heavy <- this.inherit("scripts/items/legend_helmets/hood/legend_helmet_enclave_bevor", {
	m = {},
	function create()
	{
		this.legend_helmet_enclave_bevor.create();
		this.m.ID = "armor.head.crknight_faction_helm_great_helm_heavy";
		this.m.Name = "Bevor";

this.crknight_faction_helm_great_helm_faceplate_01 <- this.inherit("scripts/items/legend_helmets/hood/legend_helmet_chain_hood", {
	m = {},
	function create()
	{
		this.legend_helmet_chain_hood.create();
		this.m.ID = "armor.head.crknight_faction_helm_great_helm_faceplate_01";

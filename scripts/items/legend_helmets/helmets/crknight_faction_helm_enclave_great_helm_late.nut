this.crknight_faction_helm_enclave_great_helm_late <- this.inherit("scripts/items/legend_helmets/hood/legend_helmet_enclave_bevor", {
	m = {},
	function create()
	{
		this.legend_helmet_enclave_bevor.create();
		this.m.ID = "armor.head.crknight_faction_helm_enclave_great_helm_late";
		this.m.Name = "Bevor";
	...
	{
		local helm = this.new("scripts/items/legend_helmets/helm/legend_helmet_enclave_great_helm");
		helm.setVariant(1);
		this.setUpgrade(helm);
		local top = this.new("scripts/items/legend_helmets/top/legend_helmet_enclave_great_jaw");
		this.setUpgrade(top);

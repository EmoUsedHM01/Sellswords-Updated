this.crgreenschrat_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crgreenschrat_potion";
		this.m.Name = "Draught of Sacred Grove";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crgreenschrat_potion_effect"));

this.crnecrosavantlord_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crnecrosavantlord_potion";
		this.m.Name = "Potion of the Dustmourn";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crnecrosavantlord_potion_effect"));

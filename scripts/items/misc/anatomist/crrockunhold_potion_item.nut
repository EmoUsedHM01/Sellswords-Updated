this.crrockunhold_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crrockunhold_potion";
		this.m.Name = "Titan's Grip Potion";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crrockunhold_potion_effect"));

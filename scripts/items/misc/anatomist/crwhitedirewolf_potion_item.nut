this.crwhitedirewolf_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crwhitedirewolf_potion";
		this.m.Name = "Potion of Blade Flurry";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crwhitedirewolf_potion_effect"));

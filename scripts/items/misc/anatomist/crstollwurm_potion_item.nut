this.crstollwurm_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crstollwurm_potion";
		this.m.Name = "Elixir of Dragonhide";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crstollwurm_potion_effect"));

this.crorcbehemoth_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crorcbehemoth_potion";
		this.m.Name = "Blood of Unchained Fury";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/potion_orcbehemoth.png";
		this.m.Value = 0;
	}
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crorcbehemoth_potion_effect"));

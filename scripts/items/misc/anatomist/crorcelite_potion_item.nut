this.crorcelite_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crorcelite_potion";
		this.m.Name = "Savage Tipple";
		...
		this.m.IconLarge = "";
		this.m.Icon = "consumables/potion_orcelite.png";
		this.m.Value = 0;
	}
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crorcelite_potion_effect"));

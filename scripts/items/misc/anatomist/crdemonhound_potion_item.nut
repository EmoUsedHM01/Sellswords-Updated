this.crdemonhound_potion_item <- this.inherit("scripts/items/misc/anatomist/anatomist_potion_item", {
	m = {},
	function create()
	{
		this.anatomist_potion_item.create();
		this.m.ID = "misc.crdemonhound_potion";
		this.m.Name = "Headless Horseman\'s Anecdote";
	...
	{
		_actor.getSkills().add(this.new("scripts/skills/effects/crdemonhound_potion_effect"));

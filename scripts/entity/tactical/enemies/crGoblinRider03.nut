this.crGoblinRider03 <- this.inherit("scripts/entity/tactical/goblin", {
	m = {
		Variant = 1,
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.crGoblinRider03;
		this.m.XP = this.Const.Tactical.Actor.crGoblinRider03.XP;
		this.goblin.create();
		this.m.ShakeLayers = [
			[
				"wolf",
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crGoblinRider03);
		...
		this.m.BaseProperties.Armor[this.Const.BodyPart.Head] += 40;
		this.m.BaseProperties.ArmorMax[this.Const.BodyPart.Head] += 40;
		this.m.BaseProperties.Armor[this.Const.BodyPart.Body] += 40;
		this.m.BaseProperties.ArmorMax[this.Const.BodyPart.Body] += 40;			
	}

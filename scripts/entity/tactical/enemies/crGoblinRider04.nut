this.crGoblinRider04 <- this.inherit("scripts/entity/tactical/goblin", {
	m = {
		Variant = 1,
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.crGoblinRider04;
		this.m.XP = this.Const.Tactical.Actor.crGoblinRider04.XP;
		this.goblin.create();
		this.m.ShakeLayers = [
			[
				"wolf",
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crGoblinRider04);

this.crGoblinRider01 <- this.inherit("scripts/entity/tactical/goblin", {
	m = {
		Variant = 1,
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.crGoblinRider01;
		this.m.XP = this.Const.Tactical.Actor.crGoblinRider01.XP;
		this.goblin.create();
		this.m.ShakeLayers = [
			[
				"wolf",
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crGoblinRider01);
		...
		this.m.BaseProperties.Armor[this.Const.BodyPart.Head] += 80;
		this.m.BaseProperties.ArmorMax[this.Const.BodyPart.Head] += 80;
		this.m.BaseProperties.Armor[this.Const.BodyPart.Body] += 80;
		this.m.BaseProperties.ArmorMax[this.Const.BodyPart.Body] += 80;			
	}

	...
	function assignRandomEquipment()
	{
		...
		if (dc <= 60)
		{
			this.m.Items.equip(this.Const.World.Common.pickArmor([
				[1, "cr_barb_king_armor_early"]
			]));
			this.m.Items.equip(this.Const.World.Common.pickHelmet([
				[1, "cr_barb_king_helmet_early"],
				[1, "cr_barb_king_helmet_mid"],
				[1, "cr_barb_king_helmet_late"]
			]));
		}
		else if (dc <= 90)
		{
			this.m.Items.equip(this.Const.World.Common.pickArmor([
				[1, "cr_barb_king_armor_mid"]
			]));
			this.m.Items.equip(this.Const.World.Common.pickHelmet([
				[1, "cr_barb_king_helmet_mid"]
			]));

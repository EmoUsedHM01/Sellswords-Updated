this.crDesperado <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crDesperado;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crDesperado.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crDesperado);

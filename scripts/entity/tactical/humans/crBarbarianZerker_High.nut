this.crBarbarianZerker_High <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crBarbarianZerker_High;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crBarbarianZerker_High.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crBarbarianZerker_High);
	...
	function assignRandomEquipment()
	{
		if (this.m.Items.hasEmptySlot(this.Const.ItemSlot.Mainhand))
		{
			local weapons = [
				...
				"weapons/barbarians/twinaxes_t2",
				"weapons/barbarians/twinaxes_t3",
				"weapons/barbarians/twinaxes_t3",

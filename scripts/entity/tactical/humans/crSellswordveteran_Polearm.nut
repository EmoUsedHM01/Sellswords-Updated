this.crSellswordveteran_Polearm <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crSellswordveteran_Polearm;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.crSellswordveteran_Polearm.XP;
		this.human.create();
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.crSellswordveteran_Polearm);
		...
		if (::Is_PTR_Exist)
		{
			...
			perkpool.extend([
				...
				[4, ["perk_head_hunter", "perk_ptr_head_smasher"], 1],
				[4, "perk_ptr_concussive_strikes", 1],
	...
	function assignRandomEquipment()
	{
		...
		if (this.m.Skills.hasSkill("perk.legend_lithe"))
		{
			...
			this.m.Items.equip(this.Const.World.Common.pickHelmet([
				...
				[1, "sellsword_helmet_medium_gladitor"],			   //225,-9				
			]));

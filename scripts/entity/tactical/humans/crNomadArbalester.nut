this.crNomadArbalester <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.crNomadArbalester;
	...
	function onInit()
	{
		...
		if (::Is_PTR_Exist)
		{
			...
			if (0.66 * dc > this.Math.rand(1, 100) && dc >= 90)
			{
